...
https://img.shields.io/badge/PyTorch-2.5.1-red?logo=pytorch
...
Install dependencies (Python 3.10, PyTorch 2.5.1 recommended)

bash
pip install -r requirements.txt
Download the datasets from Kaggle
and place the .h5 files into the data/ folder.
...
M.Sc. Engineering Physics — Technical University of Munich
GitHub
